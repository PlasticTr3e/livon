...
export function CrowdfundingCampaignCard({
  ...
  return (
    <Card className="group overflow-hidden border-green-100 transition-all hover:shadow-lg">
      ...
      <div className="p-5">
        <h3 className="mb-1 font-bold text-gray-900 transition-colors group-hover:text-green-700">
          {project.title}
        </h3>
