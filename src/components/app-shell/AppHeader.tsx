...
export function AppHeader({
  ...
  return (
    <header className="relative z-[2147483647] flex h-16 flex-none items-center justify-between border-b border-gray-200 bg-white px-4 shadow-sm dark:border-gray-800 dark:bg-[#111827]">
